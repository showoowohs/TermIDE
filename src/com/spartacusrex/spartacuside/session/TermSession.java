...
public class TermSession {
    ...
    public String getTranscriptText2(int i) {
        return mTranscriptScreen.getTranscriptText2( i);
    }
...
//            convertByteToString(mReceiveBuffer);
//            System.out.println("m"+mByteQueue.toString());
    ...
    //add
        ...
        public void convertByteToString(byte[] mReceiveBuffer) {
            
//        	for(int i = 0 ; i < mReceiveBuffer.length ; i++){
        		 //Using the static toString method of the Byte class
//                System.out.println(Byte.toString(mReceiveBuffer[i]));

                //Using simple concatenation with an empty String
//                System.out.println(mReceiveBuffer[i] + "");
                
                //Creating a byte array and passing it to the String constructor
                System.out.print(new String(new byte[] {mReceiveBuffer[mReceiveBuffer.length]}));
//        	}
//            byte b = 65;
